...
This is **PocketCoder** - an AI coding agent built using Cursor to demonstrate "agentic coding" principles. The project implements a coding assistant that can read, edit, search, and navigate codebases through natural language commands.
...
The system uses a shared memory pattern:
...
- The `.cursorrules` file contains extensive development guidance inherited from the original Cursor instructions
